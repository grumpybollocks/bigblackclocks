...
a finished app anyone can pick up, clone, and run on their own G510s or
G910, with nothing tying it back to how it was originally built. This
doc records what makes that true, and what's left before both apps get
there fully.
...
than assuming one already exists. Clone it anywhere, run the installer,
...
clone and run this" to "anyone can just `yay -S` it" — not yet started.
